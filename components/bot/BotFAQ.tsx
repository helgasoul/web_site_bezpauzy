  ...
  const faqs = [
    {
      ...
      answer: 'Есть несколько способов начать общение с Евой:\n\n1. В Telegram: откройте @bezpauzy_bot, нажмите "Начать" и следуйте инструкциям.\n\n2. На сайте: используйте кнопку "Спросить Еву" в правом нижнем углу страницы или виджет "Спросить Еву" в боковой панели.\n\n3. Из статей: нажмите кнопку "Спросить Еву" в конце любой статьи для контекстного диалога.\n\nПервые 10 вопросов в день — бесплатно.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Ева использует научную базу знаний, проверенную врачами. Все ответы основаны на актуальных международных медицинских исследованиях и рекомендациях. Однако Ева не заменяет консультацию врача — она даёт образовательную информацию.',
    },
    {
